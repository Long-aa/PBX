...
$html = 
	...
	"<p>"._("You are attempting to modify settings from a URL that does not appear to have come from a XenoAI PBX page link or button. This can occur if you manually typed in the URL below. This action has been blocked because the HTTP_REFERER does not match your current SERVER. If you require this access, you can set Check Server Referrer=false in Advanced Settings to disable this security check")."</p>\n".
